...
const ARTherapyApp = () => {
  ...
  const capturePhoto = () => {
    ...
    link.download = `MEDICONNECT_AR_${currentExercise?.exerciseName || 'Exercise'}_${new Date().toISOString().replace(/[:.]/g, '-')}.png`;
      ...
      <div className="flex flex-col w-full h-full relative">
        ...
        <div className="flex items-center justify-between px-4 py-3 bg-background/90 backdrop-blur-xl shadow-lg z-20 border-b border-border">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl text-primary">MEDICONNECT AR</span>
          </div>
